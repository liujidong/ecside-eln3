...
//    private Object[] expressionPropertys;
    ...
    public CellExpression getExpression(String name){
    	return (CellExpression)expressionMap.get(name);
    }

    public void addExpression(String name, CellExpression expression){
