...
//			LogHandler.errorLog(logger, msg);
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            //this.locale=pageContext.getRequest().getLocale().getLanguage()+"_"+pageContext.getRequest().getLocale().getCountry();
            this.locale=pageContext.getRequest().getLocale().toString();
...
//    }
    ...
    public void setSortable(String sortable) {
        ...
        //this.sortable=Boolean.TRUE.toString();//让它显示排序功能
    }
    ...
    public void setSortRowsCallback(String sortRowsCallback) {
        ...
        this.sortRowsCallback="process";////让它显示排序功能时重内存提取数据
    }
