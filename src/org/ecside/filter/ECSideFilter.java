...
//    public void initEasyList() throws ServletException {
//    	useEasyList=false;
//    	String useEasyListC = filterConfig.getInitParameter("useEasyList");
//    	if ("on".equalsIgnoreCase(useEasyListC)||"true".equalsIgnoreCase(useEasyListC)
//    			|| "yes".equals(useEasyListC)|| "1".equals(useEasyListC) ){
//    		useEasyList=true;
//    	}
//    	easyListHandler=new EasyListHandler();
//    }
...
//        response.setHeader("Content-Type",mimeType);
         try {
        	 exportFileName= RequestUtil.encodeFileName(request,exportFileName);
